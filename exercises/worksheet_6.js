...
const EXERCISES_W6 = [
  ...
  // ─── Felsorolás (enumeration / list) típus ─────────────────────────────────
  {
    "id": "w6_32",
    "w": 6,
    "topic": "Intellektuális fogyatékosság",
  ...
  },
  {
    ...
    "need": 4,
    "exp": "Az öt szempont: intellektuális képességek, adaptív viselkedés, részvétel/interakciók/szociális szerepek, egészségi állapot, kontextus (környezeti és személyes tényezők) – csapatmunkában, a PIP megalapozására.",
    "diff": 3
  },
  {
    "id": "w6_34",
    ...
    "need": 4,
    "exp": "Az öt alapelv: konkretizálás (szemléltetés), kis lépések elve (task analysis), ismétlés, transzfer (több kontextusban gyakorlás), megerősítés (azonnali pozitív visszajelzés).",
    "diff": 2
  },
  {
    "id": "w6_35",
    ...
    "need": 3,
    "exp": "A három szakasz: gyakorló-/szenzomotoros játék (0–2 év), szimbolikus/szerepjáték (2–7 év, mintha játék), szabályjáték (7 év felett).",
    "diff": 2
  },
  {
    "id": "w6_36",
    ...
    "need": 4,
    "exp": "A négy alkotóelem: didaktikai cél, játékos tartalom (elemek), játékszabályok, játékos akció (eszközök, cselekvések).",
    "diff": 2
  },
  {
    "id": "w6_37",
    ...
    "need": 3,
    "exp": "A négy forma: egyéni tanulás, kiscsoportos tanulás (3–6 fő), többszintű tanulás (azonos téma eltérő szinteken), team-teaching (két pedagógus közös órája).",
    "diff": 2
  }
];
